...
If we were to then increase the `restart` parameter from e.g. 1 to 1000, we 
still get the same result because `hc` (likely) manages to find the global optimum.
...
This is reflected in the fact that the structures learned in asg. 2-3 look very different.
